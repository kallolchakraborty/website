// Shared Tailwind theme for the terminal portfolio.
// All colors are CSS variables so the .dark class can flip the whole site.
// Loaded by every page before the Tailwind CDN.
tailwind.config = {
  darkMode: "class",
  theme: {
    extend: {
